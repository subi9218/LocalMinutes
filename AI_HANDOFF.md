...
1. 앱 첫 실행
   ...
   - "회의 내용은 기기 밖으로 나가지 않습니다"와 외부 서버 미전송을 첫 단계에서 강조
...
- 앱 이름: `Local Minutes`
- 부제: `온디바이스 AI 회의록 정리`
- 홍보 문구: `오프라인 기반 회의 녹음부터 전사, 요약, 액션아이템까지 한 기기에서 처리하세요. 외부 서버 업로드 없이 중요한 회의를 정리합니다.`
...
- 첫 화면에서 녹음/STT/화자 분리/요약이 모두 사용자의 기기에서 실행되며 외부 서버로 전송하지 않는다는 점을 강조
